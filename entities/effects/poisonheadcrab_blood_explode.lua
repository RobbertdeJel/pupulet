...
local particleTable = {
	[ 1 ] = { particle = "decals/yblood1", sizeStart = 8, sizeEnd = 1, startAlpha = 180, endAlpha = 0, randXY = 25, randZMin = -10, randZMax = 124, color = Color( 80, 0, 0 ), rotRate = 16, lifeTimeMin = 1.8, lifeTimeMax = 2.9 },
	[ 2 ] = { particle = "decals/blood2", sizeStart = 0, sizeEnd = 6, startAlpha = 110, endAlpha = 0, randXY = 12, randZMin = -20, randZMax = 98, color = Color( 240, 240, 0 ), rotRate = 9, lifeTimeMin = 2.6, lifeTimeMax = 3.9 }
}
...
local function CollideCallback(oldparticle, hitpos, hitnormal)
	...
	if math.random(3) == 3 then
		...
		util.Decal("poisonHeadCrab", pos, hitpos - hitnormal)
	end
